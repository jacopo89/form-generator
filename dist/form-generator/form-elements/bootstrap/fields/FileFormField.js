...
export default function FileFormField(props) {
    ...
    return _jsxs(_Fragment, { children: [_jsx("div", { children: Header }), existingFile && _jsxs(_Fragment, { children: [existingFile.url && _jsx(Button, Object.assign({ onClick: onDownloadFile }, { children: "Download file" })), !disable && _jsx(Button, Object.assign({ onClick: () => { setFieldValue(null); } }, { children: "Rimuovi file" }))] }), !existingFile && !disable && _jsxs(_Fragment, { children: [_jsx(Dropzone, { onSubmit: (successFiles) => {
                        ...
                        }, submitButtonDisabled: true, submitButtonContent: _jsx("button", { style: { height: "0!important", width: "0!important" }, hidden: true }), PreviewComponent: DropzonePreview, accept: accept, maxFiles: 1, maxSizeBytes: maxFileSizeMB * 1024 * 1024, inputContent: "Carica file" }), _jsxs("p", Object.assign({ style: { fontSize: 10 } }, { children: ["Max File Size: ", maxFileSizeMB, "MB"] }))] }), !existingFile && disable && _jsx("div", { children: "Nessun file caricato" })] });
}
