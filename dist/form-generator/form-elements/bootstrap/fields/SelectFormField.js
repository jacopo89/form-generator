...
export default function SelectFormField(element) {
    ...
    return _jsxs(_Fragment, { children: [label !== false && _jsx(Form.Label, { children: label !== null && label !== void 0 ? label : Header }), _jsx(Select, { styles: {
                    control: (baseStyles, state) => (Object.assign(Object.assign({}, baseStyles), { borderColor: hasError ? "red" : baseStyles.borderColor }))
                }, isDisabled: disable, classNamePrefix: "react-select", options: options, value: value, onChange: (value) => setFieldValue(value === null || value === void 0 ? void 0 : value.value), placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : "" }), _jsx("span", Object.assign({ style: { visibility: hasError ? "visible" : "hidden" }, className: "small text-danger" }, { children: nestedError !== null && nestedError !== void 0 ? nestedError : "Error" }))] });
}
