...
export default function TagsFormField(props) {
    ...
    return _jsx("div", Object.assign({ className: "filled form-group tooltip-end-top d-flex" }, { children: _jsx(ReactTags, { minQueryLength: 0, tags: tags, allowNew: true, onDelete: onTagDelete, onAddition: onTagAddition, placeholderText: Header }) }));
}
