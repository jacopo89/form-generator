...
export default function SelectFormField(element) {
    ...
    return _jsxs(_Fragment, { children: [label !== false && _jsx("span", { children: label !== null && label !== void 0 ? label : Header }, void 0), _jsx(TextField, Object.assign({ disabled: disable, error: nestedTouched && nestedError !== undefined, fullWidth: true, helperText: nestedTouched ? (nestedError !== null && nestedError !== void 0 ? nestedError : "") : "", onChange: (e) => setFieldValue(e.target.value), select: true, placeholder: placeholder, value: (_a = value === null || value === void 0 ? void 0 : value.value) !== null && _a !== void 0 ? _a : "", variant: "outlined" }, { children: options.map((option) => (_jsx(MenuItem, Object.assign({ value: option.value }, { children: option.label }), option.value))) }), void 0)] }, void 0);
}
